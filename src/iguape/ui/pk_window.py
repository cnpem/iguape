...
class Ui_pk_window(object):
    ...
    def retranslateUi(self, pk_window):
        ...
        self.pk_combo_box.setItemText(
            1, _translate("pk_window", "Split PseudoVoigt Model - 2x PseudoVoigt")
        )
        self.theta_interval_label.setText(
            _translate(
                "pk_window",
                '<html><head/><body><p><span style=" text-decoration: underline;">2θ Interval Selected:</span></p></body></html>',
            )
        )
        self.bgk_label.setText(
            _translate(
                "pk_window",
                '<html><head/><body><p><span style=" text-decoration: underline;">Background Model:</span></p></body></html>',
            )
        )
        self.pk_label.setText(
            _translate(
                "pk_window",
                '<html><head/><body><p><span style=" text-decoration: underline;">Peak Profile:</span></p></body></html>',
            )
        )
        ...
        self.height_label.setText(
            _translate(
                "pk_window",
                '<html><head/><body><p><span style=" text-decoration: underline;">Height (x1e+09 a.u.):</span></p></body></html>',
            )
        )
        self.bgk_combo_box.setItemText(0, _translate("pk_window", "Linear Model"))
        self.xrd_label.setText(
            _translate(
                "pk_window",
                '<html><head/><body><p><span style=" text-decoration: underline;">XRD pattern:</span></p></body></html>',
            )
        )
        ...
        self.distance_label.setText(
            _translate(
                "pk_window",
                '<html><head/><body><p><span style=" text-decoration: underline;">Distance:</span></p></body></html>',
            )
        )
