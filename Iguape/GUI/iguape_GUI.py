...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.reset_button, 0, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.peak_fit_button, 0, 4, 1, 1)
        self.index_label = QtWidgets.QLabel(self.centralwidget)
        self.index_label.setObjectName("index_label")
        self.gridLayout.addWidget(self.index_label, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.max_filter_label, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.offset_slider, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.save_peak_fit_data_button, 1, 4, 1, 1)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("Icons/Filter_Icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.filter_button.setIcon(icon3)
        self.filter_button.setObjectName("filter_button")
        self.gridLayout.addWidget(self.filter_button, 2, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.max_temp_doubleSpinBox_2, 3, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.min_temp_doubleSpinBox, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.min_filter_label, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.temperature_checkbox, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.XRD_measure_order_checkbox, 1, 1, 1, 1)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("Icons/Refresh_Icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.normalize_checkBox)
        self.contour_button = QtWidgets.QPushButton(self.groupBox)
        self.contour_button.setObjectName("contour_button")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.contour_button)
        ...
        self.gridLayout_3.addWidget(self.paineir_logo, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(_translate("MainWindow", "Custom Tools"))
        self.comboBox.setItemText(0, _translate("MainWindow", "LogNorm"))
        self.comboBox.setItemText(1, _translate("MainWindow", "PowerNorm"))
        self.comboBox.setItemText(2, _translate("MainWindow", "CenteredNorm"))
        self.label_2.setText(_translate("MainWindow", "Contour Norm"))
        self.label.setText(_translate("MainWindow", "Color Palette"))
